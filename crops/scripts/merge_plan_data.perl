...
# obsolete?  since summer nursery rows now standardized at 20 cl/row
# tossed in 0 cl to trigger an eyeball warning
#
# Kazic, 31.5.2021

# if ( $current_crop =~ /\d+[rR]/ ) { $cl = 15; }
if ( $current_crop =~ /\d+[rR]/ ) { $cl = 20; }
...
my $prolog_packing_file = $dir . $planning_root . "packing_plan.pl";
...
# concatenating the plans and comments gives horrible results that must be
# hand-edited.  It would be good to figure out another approach.
#
# Kazic, 31.5.2021
...
% generated by ../maize/crops/merge_plan_data.perl in operation merge
...
# Kazic, 21.4.2015
                                ...
                                if ( ( $_ =~ /\[inbred\]/ ) || ( $_ =~ /\[elite\]/ ) ) { print $out $_; }
...
# change value as needed if nursery is split among fields, so that the 
# stakes begin at a different number
#	
# Kazic, 31.5.2021
