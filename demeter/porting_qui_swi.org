...
<2018-11-01 Thu>:
AND another issue:  make sure [[file:../data/convert_data/convert_harvest_data.perl][convert_harvest_data.perl]] grabs the harvest
days data from [[file:data/row_harvested.pl][row_harvested.pl]].
