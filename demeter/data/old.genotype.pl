% this is demeter/data/genotype.pl
%
% cleaned by clean_data:clean_data/4 on 16.4.08
%
% Kazic, 16.4.08
%
...
genotype(0000,0000,'11R0000:0000000',0000,'11R0000:0000000','','','','',[],'').
...
genotype(2290,1013,'06N1013:0000308',1013,'06N1013:0000301','Mo20W','Mo20W','Mo20W','Mo20W/Les2',['Les2'],'K0202').
...
% row I6 was M14, not Mo20W; row I16 was Mo20W.  Notice families 1000 and 1010 are otherwise
% duplicated.  I believe this is the original transcriptional error that has always confused the issue of
% the maternal parent for 06R0001:0000104 --- I could never find 06R200:S00I0608 despite looking 
% multiple times over the years, while I could find 06R200:S00I1608.
%
% So we will look one last time for 06R200:S00I0608, then insert a zero kernel fact for it in the new
% inventory, and comment out this genotype fact.  I need to set IntercalatedNums in 
% crop_management:find_available_family_numbers/2 or in 
% clean_data:find_gaps/2 to [] to prevent reuse of retired family numbers.
%
% Kazic, 22.5.2014
%
...
%
% cut and paste error, row I12 is W23 in 06N, as shown by /athe/c/maize/crops/planning/06r/06r_cross_planning.ods
%
% fixed by hand and all family descendents confirmed to be correct genotype
%
% Kelly and Kazic 22.5.14
% 
% genotype(2980,300,'06R300:W00I1216',76,'06R0076:0007609','Mo20W','Mo20W','{+|Les*-N1450}','{+|Les*-N1450}',['Les*-N1450'],'K7609').
genotype(2980,300,'06R300:W00I1216',76,'06R0076:0007609','W23','W23','{+|Les*-N1450}','{+|Les*-N1450}',['Les*-N1450'],'K7609').
...
%
% row 408 is family 2343 in all other instances, therefore we believe this is a cut and past error
% 1738 has no descendents.
% 
% we are silently editing the family number from 2347 to 2343
%
% Kelly and Kazic, 22.5.2014
%
% genotype(1738,301,'07R301:W0025407',2347,'07R2347:0040803','W23','W23','W23','(W23/M14)/(Mo20W/Les4)',['Les4'],'K0303').
%
genotype(1738,301,'07R301:W0025407',2343,'07R2343:0040803','W23','W23','W23','(W23/M14)/(Mo20W/Les4)',['Les4'],'K0303').
%
...
%
% oops!  07R row 406 was really family 2346; 07R row 409 was really family 2345.  We have
% two other members of row 409 and four members of 406 that were crossed that year.
% And hooray, no descendants of family 1804! Whew.
%
% So we are silently correcting the family number from 2345 to 2346 for the following fact.
% The genotype was already correct.
%
% It was probably a cut and paste error.
%
% Kelly and Kazic, 22.5.2014
%
% genotype(1804,301,'07R301:W0030517',2345,'07R2345:0040604','W23','W23','M14','(M14/Mo20W)/Les4',['Les4'],'K0303').
%
genotype(1804,301,'07R301:W0030517',2346,'07R2346:0040604','W23','W23','M14','(M14/Mo20W)/Les4',['Les4'],'K0303').
%
%
...
%
% Note that this change DOES NOT ALTER the Les20-N2457 pedigree, since pedigrees are calculated using crop and 
% rowplant.
% 
% Kazic, 21.4.2013
...
genotype(3562,501,'11N0501:0030601',3402,'11N3402:0008110','B73','B73','Mo20W','Les2',['Les2'],'K0203').
...
% Kazic, 21.4.2013
%
% so why do we have a genotype fact?  I must have been counting unhatched chickens!
% Commented out the following:  but make SURE number is not reused when generating new genotypes for
% the planted 14R corn.
%
% Kazic, 22.5.2014
%
